...
def create_course(request):
    ...
    if request.method == "POST":
        ...
        course = Course.objects.create(name=request.POST.get("course-name"),code=request.POST.get("course-code"),level=request.POST.get("level"), unit=float(request.POST.get("course-unit")) ,semester=request.POST.get("semester"),course_type=request.POST.get("course_type"),department=department)
...
def manage_department(request):
    if request.method == "POST":
        print(request.POST)
        Department.objects.create(name=request.POST.get("department"),core_units=request.POST.get("core_units"),elective_units=request.POST.get("elective_units"), general_units=request.POST.get("general_units"))
